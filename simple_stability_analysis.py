...
def analyze_stability_simple():
    """
    简化的稳定性分析
    """
    # 读取CSV文件
    csv_file = Path('results/allocation_stability_analysis_20260428_172712.csv')
    ...
    # 保存图像
    plot_filename = "results/stability_simple_analysis.png"
